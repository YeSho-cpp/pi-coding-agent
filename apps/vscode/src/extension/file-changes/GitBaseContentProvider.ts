...
export const GIT_BASE_SCHEME = "frostui-git-base";
...
export class GitBaseContentProvider implements vscode.TextDocumentContentProvider {
  ...
  async provideTextDocumentContent(uri: vscode.Uri): Promise<string> {
    ...
    if (!root || !path) throw new Error("Invalid Pi Git base URI");
    try {
      ...
      return `Pi could not read the Git HEAD version of this file.\n\n${message}`;
    }
  }
