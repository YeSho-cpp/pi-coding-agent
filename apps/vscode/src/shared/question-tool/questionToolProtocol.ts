...
export const QUESTION_TOOL_MARKER_PREFIX = "frostui_QUESTION";
export const QUESTION_TOOL_TOKEN_ENV = "frostui_QUESTION_TOKEN";
export const QUESTION_TOOL_REQUEST_DIR_ENV = "frostui_QUESTION_REQUEST_DIR";
...
export function encodeQuestionToolMarker(token: string, requestId: string): string {
  if (!validToken(token) || !validRequestId(requestId)) throw new Error("Invalid Pi Coding Agent Question marker identity");
