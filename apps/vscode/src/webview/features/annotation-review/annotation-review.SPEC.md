...
- The annotation envelope is placed before the existing Composer text with two separating newlines. Existing text and attachments are preserved exactly, focus moves to the end, and Frost UI never sends automatically.
